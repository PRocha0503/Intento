...
def main_account_screen():
    ...
    Label(text="").pack()
    Label(text="").pack()
    Button(text="Login 1", height="2", width="30", command = login).pack() # create Login Button
    Label(text="").pack()
...
def registro():
    ...
    boton_menu2 = tkinter.Button(ventana4, text = "Menú", command=ventana4.destroy).place(x = 320, y = 250)
    boton_registrar = tkinter.Button(ventana4, text = "Registrar", command= registrarBD).place(x = 250, y = 190)

    #funcion para agregar datos de persona registrada a base de datos
    #-----------------------------------------------

    nombre=tkinter.Label(ventana4,text="Nombre").place ( x = 100, y = 5)
    apellidop=tkinter.Label(ventana4,text="Apellido Paterno").place ( x = 100, y = 25)
    apellidom=tkinter.Label(ventana4,text="Apellido Materno").place ( x = 100, y = 50)
    edad=tkinter.Label(ventana4,text="Edad").place ( x = 100, y = 73)
    genero=tkinter.Label(ventana4,text="Género").place ( x = 100, y = 95)
    escolaridad=tkinter.Label(ventana4,text="Escolaridad").place ( x = 100, y = 115)
    ocupacion=tkinter.Label(ventana4,text="Ocupación").place ( x = 100, y = 140)
    
    textBox_nombre = tkinter.Entry(ventana4)
    textBox_nombre.pack(side=tkinter.TOP)
    textBox_apellidop = tkinter.Entry(ventana4)
    textBox_apellidop.pack(side=tkinter.TOP)
    textBox_apellidom = tkinter.Entry(ventana4)
    textBox_apellidom.pack(side=tkinter.TOP)
    textBox_edad = tkinter.Entry(ventana4)
    textBox_edad.pack(side=tkinter.TOP)
    textBox_genero = tkinter.Entry(ventana4)
    textBox_genero.pack(side=tkinter.TOP)
    textBox_escolaridad = tkinter.Entry(ventana4)
    textBox_escolaridad.pack(side=tkinter.TOP)
    textBox_ocupacion = tkinter.Entry(ventana4)
